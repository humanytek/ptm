...
##############################################################################
{
    ...
    'description': """
	   ...
	   - Auxiliar de cuentas
	   - Diario General
	   - Balance de Situacion (Mes actual vs. Acumulado)
	   - Estado de Resultados (Mes actual vs. Acumulado)
	Todos los informes son exportables para realizar todo lo relacionado a reportes fiscales, asi como analisis particulares
